...
int main() {
    ...
    for (auto it = numbers.begin(); it != numbers.end(); ++it) { // auto is a placeholder for the type of the iterator (similar to var in C#)
        std::cout << *it << " ";
    }
    std::cout << std::endl;
    ...
    otherPeople.emplace_back("Frank", 50);
    otherPeople.emplace_back("Grace", 45);
